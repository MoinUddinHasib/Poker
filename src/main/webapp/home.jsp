	...
	<main role="main">
	  ...
	  <div class="jumbotron" >
	    <div class="container">
	      ...
	      <p><a class="btn btn-primary btn-lg" href="PlayServlet" role="button">Play Management &raquo;</a></p>
	      <p><a class="btn btn-primary btn-lg" href="TavoloServlet" role="button">Gestione Tavolo &raquo;</a></p>
