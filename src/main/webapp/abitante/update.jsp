    ...
    <div class="page-header">
	  <h3>Pagina di Modifica Abitante</h3>
		...
		<form class="form-horizontal" action="ExecuteModificaAbitanteServlet"
			method="post">
			<input type="hidden" id="idAbitante" name="idAbitante" value="${abitanteAttribute.id }">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" type="text" id="municipioInputId"
						name="municipioInput" value="${municipioInput }">
					<input type="hidden" name="municipioId" id="municipioId" value="${municipioId }">
				</div>
			</div>
